...
cat << EOF > /etc/systemd/system/bzedged.service
[Unit]
Description=BZEdge service
...
ExecStart=/home/bzedge/bzedged/src/bzedged -datadir=/home/bzedge/.bzedge/ - conf=/home/bzedge/.bzedge/bzedge.conf -daemon
